...
export default function ModalDocumentItem({
    id,
    user,
    file,
    uploaded_at,
    ...
    const chooseHandler = (e) => {
        ...
        if (container.classList.contains('choosedDocument')) {
            container.classList.remove('choosedDocument')
            ...
            container.classList.add('choosedDocument')
            chooseDocument(id);
        }
    }
    ...
    return(
        <>
            <div className="modalDocumentItem">
                ...
                <div>
                    <p>Uploaded_at: {formatDate(uploaded_at)}</p>
