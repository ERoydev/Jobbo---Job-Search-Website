...
export default function MyDocumentsItem({
    ...
    return (
       <div className="documentsItem">
            ...
            <div>
                <button className="auth-btn" onClick={() => downloadClickHandler(id)}>Download</button>
                <p className="documentInfo">Uploaded_at: {formatDate(uploaded_at)}</p>
            </div>
       </div>
    );
}